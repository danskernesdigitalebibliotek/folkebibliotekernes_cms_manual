...
Den nye version af avanceret søgning er baseret på 1. de ønsker, som vi har fået ind, 2. bibliotek.dks løsning og 3. de snakke og input, som vi har haft med ansatte fra bibliotekerne. 

Vær opmærksom på at den nye avanceret søgning er på urlen /advancedsearch. Den gamle avanceret søgning er på /advanved-search. Det har vi gjort for at link i jeres indhold til søgning ikke går i stykker. I 2026 kigger vi på CQL-søgning, så der skal vi undersøge om det stadig påvirker jeres indhold. Det melder vi ud om i 2026. 

### Kommer inden jul 

Inden jul har vi lavet det som er prioriteret i forhold til de ønsker, som bibliotekerne har meldt ind.  

#### Designløft 

Designet har fået et løft, hvor vi har strammet op. En af de store forbedringer vi har lavet, er at når man har lavet en søgning, så scroller siden ikke automatisk ned til resultaterne. I stedet har man en bjælke, hvor man hele tiden kan se sin søgning, og trykke på ‘Redigér søgning’. 

#### Automatisk forslag i søgefelter og afgræsningsmuligheder 

Nu skal brugerne ikke længere gætte inputmulighederne i søgefelter og afgrænsningsmulighederne. I stedet får de forslag fra brønden. Vi har lavet flere typer af inputmuligheder: autosuggest til fx titler og emner, lister til fx materialetype og kilde, intervaller til fx alder og udgivelsesår. 

#### Filtre efter endt søgning 

Vi har tilføjet filtrer i venstre side når man har lavet en søgning. Det er så man kan videreindsnævre sit resultat mod de ønskede materialer. 

#### Nemmere at finde avanceret søgning 

Vi har fjernet pilen ved siden af forstørrelsesglasset i headeren, og i stedet introduceret en knap, der ret tydeligt indikerer at man kan komme videre til avanceret søgning. 
...
#### Filtre efter endt søgning i simple search 

De filtre som vi introducerer på resultatsiden i avanceret søgning ønsker vi skal erstatte de facetbåndet og de eksisterende filtre. 
...
På arrangementer har den store opgave været at løfte designet. Vi har strammet flere ting op og ordnet, så visningen er mere overskuelig på arrangementssiden, i paragrafer og på lister. Derudover har vi skruet på både desktop- og mobilvisning. Vi mener dog ikke vi er helt færdige, så vi færdigpudser designet i det nye år. 
...
Vi har lavet flere forskellige forbedringer fx 1. at man nemt kan kopiere indhold fra en arrangementsserie til en instans, så man ikke skal genindtaste alt, 2. at man kan fravælge indhold i automatiske oversigter, 3. at man kan oprette arrangementer uden klokkeslæt etc.  
...
Vi har lavet en hjælpebjælke til borgere, der ikke kan finde det, som de søger efter i søgningen. Den kan I selv indstille i konfigurationen. 

### Andet 

Vi har lavet en masse andre opgaver fx 1. det er nu muligt, tilrette sin 0-hits søgning, 2. man kan kopiere link til en bestemt udgave, 3. I har mulighed for at altid have ‘Find på hylden’ udfoldet. 

## Lånerstatus og brugerprofil 

Dette emneområde har været en samling af mindre og mellemstore forbedringer til lånerstatus og brugerprofil. Rettelser har været forbedringer af brugerrejse og information. Et par af opgaverne i dette emneområde når ikke at komme med i den sidste release i år, da sikkerhedsopdateringen i 2025.48.2 gjorde at vi ikke kunne nå at teste dem. De kommer i stedet i en af de første releases i 2026. 
