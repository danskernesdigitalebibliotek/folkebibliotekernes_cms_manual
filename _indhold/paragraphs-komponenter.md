...
### Simple links
Simple links kan bruges til at vise et eller flere links. Der bliver ikke vist ikoner på Simple links. Tilføjer man flere links, vises de lige under hinanden i en slags kolonne. Når man tilføjer eksterne links, skal man huske at starte med `https://` - ellers virker de ikke.
...
### Links
Tilknytning af link til artiklen, fx interne/eksterne links og links til søgeresultater.
